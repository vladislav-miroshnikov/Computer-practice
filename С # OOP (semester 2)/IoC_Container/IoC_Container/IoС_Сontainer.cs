...
namespace IoС_Container
{
    ...
    public class IocContainerClass
    {
        ...
        public void IocContainerTest()
        {
            ...
            container.RegisterType<AbstractMan, BotFisrt>("BotFirst", new InjectionConstructor(1000,0));
            container.RegisterType<AbstractMan, BotSecond>("BotSecond", new InjectionConstructor(1000, 0));
